        ...
        <div className="App-payment">
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="form-actions">
              <button className="btn btn-primary btn-block"  style={{backgroundColor:'blue', borderRadius: '10px',marginLeft:'210px',width:'100px',padding:'10px',color:'white' }}>
                <Link to="/final" style={{ color: 'white', textDecoration: 'none' }}>PAY</Link>
              </button>
            </div>
